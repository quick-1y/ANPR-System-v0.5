...
- **Классификация** — APPROACHING (к камере), если доминирует вертикальное смещение вниз/рост рамки; RECEDING (от камеры), если смещение вверх/сжатие рамки. В интерфейсе направление выводится текстом: «К камере» и «От камеры».
