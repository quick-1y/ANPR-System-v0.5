...
### Валидация номеров
- **Плагины стран** — YAML-конфиги в `anpr/plates/configs` с регэкспами форматов и правилами коррекции OCR
- **Коррекция OCR** — перевод цифр в похожие буквы, латиница → кириллица (для кириллических шаблонов), удаление пробелов/дефисов
...
- **Схема таблицы**:
  ...
  - `plate_format` — совпавший шаблон номера
